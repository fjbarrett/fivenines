...
// providers (aws, azure, oracle, ibm, tencent) had their marks pulled from that
// set by their trademark owners, so they fall back to a clean monogram tile.
...
const PATHS: Record<string, string> = {
  ...
  // card name is "Akamai Linode" → Akamai mark
  linode:
...
// Trademark-restricted marks → monogram fallback.
