...
PROVIDERS = [
    ...
    # --- additional platforms (hosting / data / dev) -------------------------
    dict(key="github", name="GitHub", method="statuspage",
         status="https://www.githubstatus.com/api/v2/status.json",
         reach=["https://github.com", "https://api.github.com"],
         dns=["github.com", "api.github.com"],
         page="https://www.githubstatus.com",
         regions={"kind": "components", "url": "https://www.githubstatus.com/api/v2/components.json"}),
    dict(key="netlify", name="Netlify", method="statuspage",
         status="https://www.netlifystatus.com/api/v2/status.json",
         reach=["https://www.netlify.com", "https://api.netlify.com"],
         dns=["www.netlify.com", "api.netlify.com"],
         page="https://www.netlifystatus.com",
         regions={"kind": "components", "url": "https://www.netlifystatus.com/api/v2/components.json"}),
    dict(key="render", name="Render", method="statuspage",
         status="https://status.render.com/api/v2/status.json",
         reach=["https://render.com", "https://dashboard.render.com"],
         dns=["render.com"],
         page="https://status.render.com",
         regions={"kind": "components", "url": "https://status.render.com/api/v2/components.json"}),
    dict(key="flyio", name="Fly.io", method="statuspage",
         status="https://status.flyio.net/api/v2/status.json",
         reach=["https://fly.io"],
         dns=["fly.io"],
         page="https://status.flyio.net",
         regions={"kind": "components", "url": "https://status.flyio.net/api/v2/components.json"}),
    dict(key="supabase", name="Supabase", method="statuspage",
         status="https://status.supabase.com/api/v2/status.json",
         reach=["https://supabase.com"],
         dns=["supabase.com"],
         page="https://status.supabase.com",
         regions={"kind": "components", "url": "https://status.supabase.com/api/v2/components.json"}),
    dict(key="mongodb", name="MongoDB Atlas", method="statuspage",
         status="https://status.mongodb.com/api/v2/status.json",
         reach=["https://www.mongodb.com", "https://cloud.mongodb.com"],
         dns=["www.mongodb.com", "cloud.mongodb.com"],
         page="https://status.mongodb.com",
         regions={"kind": "components", "url": "https://status.mongodb.com/api/v2/components.json"}),
    dict(key="snowflake", name="Snowflake", method="statuspage",
         status="https://status.snowflake.com/api/v2/status.json",
         reach=["https://www.snowflake.com"],
         dns=["www.snowflake.com"],
         page="https://status.snowflake.com",
         regions={"kind": "components", "url": "https://status.snowflake.com/api/v2/components.json"}),

    # --- CDNs ----------------------------------------------------------------
    dict(key="akamai", name="Akamai", method="statuspage",
         status="https://www.akamaistatus.com/api/v2/status.json",
         reach=["https://www.akamai.com"],
         dns=["www.akamai.com"],
         page="https://www.akamaistatus.com",
         regions={"kind": "components", "url": "https://www.akamaistatus.com/api/v2/components.json"}),
    dict(key="bunny", name="Bunny.net", method="statuspage",
         status="https://status.bunny.net/api/v2/status.json",
         reach=["https://bunny.net"],
         dns=["bunny.net"],
         page="https://status.bunny.net",
         regions={"kind": "components", "url": "https://status.bunny.net/api/v2/components.json"}),
]
